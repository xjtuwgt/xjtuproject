...
from multihopr.hotpotqaIOUtils import load_model
import argparse
import logging
import os
...
from multihopQA.QATrainFunction import get_date_time, read_train_dev_data_frame
    ...
    with torch.no_grad():
        for test_sample in test_data_loader:
            ...
            if step % args.test_log_steps == 0:
                logging.info(
                    'Testing the model... {}/{} in {:.4f} seconds'.format(step, total_steps, time() - start_time))
    ##=================================================
